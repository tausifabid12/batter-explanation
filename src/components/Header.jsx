    ...
    <header className="w-full p-4 bg-white text-gray-900 font-semibold shadow-md z-50">
      <div className="container flex justify-between h-16 mx-auto">
        ...
        >
          ...
          <p className="font-bold text-gray-900">Better Explanation</p>
        </Link>
        <ul className="items-stretch hidden space-x-3 lg:flex">
          <li className="flex">
            <Link
              rel="noopener noreferrer"
              to="/"
              className="flex items-center px-4 -mb-1 border-b-2 border-transparent text-[#aa076b] border-[#aa076b]"
            >
              Home
            </Link>
          </li>
