...
const Login = () => {
  ...
  return (
    <div className=" sm:w-[90%] md:w-3/4 bg-white mx-auto   p-1 rounded-md sm:p-10 ">
      <form
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border rounded-md  focus:border-[#aa076b]"
            />
          </div>
          <div>
      ...
      <div className="flex justify-center space-x-4">
        <button
          ...
          className="p-3 rounded-sm hover:text-[#aa076b]"
        >
          <svg
